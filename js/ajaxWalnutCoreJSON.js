...
// first get user radio button choice
    ...
    if (user_input) {
        ...
        if (user_input === "add") {
            openResult = window.open("https://" + theHost + "/walnuts/addNut.html", "_self");
            return false;
        }
        if (user_input === "list") {
            openResult = window.open("https://" + theHost + "/walnuts/listNuts.html", "_self"); // listNuts.html only called by Foxy
            return false;
        }
